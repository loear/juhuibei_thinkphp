...
Modernizr.load({
  ...
  nope: '/static/plugins/forms/placeholder/jquery.placeholder.min.js',
  complete: function () {
...
Modernizr.load({
  ...
  yep: ['/static/plugins/fix/ios-fix/ios-orientationchange-fix.js', '/static/plugins/fix/touch-punch/jquery.ui.touch-punch.min.js']
});
