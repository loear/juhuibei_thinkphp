$(document).ready(function(){
    ...
    $('#demo-fileInput-4').filer({
        changeInput: '<div class="jFiler-input-dragDrop"><div class="jFiler-input-inner"><div class="jFiler-input-icon"><i class="icon-jfi-folder"></i></div><div class="jFiler-input-text"><h3>点击虚线框</h3> <span style="display:inline-block; margin: 15px 0">或</span></div><a class="jFiler-input-choose-btn blue-light">点此选择图片</a></div></div>',
        showThumbs: true,
        theme: "dragdropbox",
